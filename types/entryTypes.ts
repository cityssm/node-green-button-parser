...
export interface ApplicationInformationEntry
  extends BaseEntry<ApplicationInformationContent> {
...
export interface CustomerAccountEntry
  extends BaseEntry<CustomerAccountContent> {
  content: CustomerAccountContent
}

export interface CustomerAgreementEntry
  extends BaseEntry<CustomerAgreementContent> {
  content: CustomerAgreementContent
}

export interface ElectricPowerQualitySummaryEntry
  extends BaseEntry<ElectricPowerQualitySummaryContent> {
...
export interface LocalTimeParametersEntry
  extends BaseEntry<LocalTimeParametersContent> {
...
export interface ServiceLocationEntry
  extends BaseEntry<ServiceLocationContent> {
...
export interface ServiceSupplierEntry
  extends BaseEntry<ServiceSupplierContent> {
